...
1. **Conventional Commits**: For a long time I have been thinking about to follow a pre-defined convention for **GIT
   commits** but where-ever I check I don't understand then I came across
...
![18-02-2024](../assets/joey-mail-backdropbuild.png "Joey's mail to join the program."){ .base-border-radius }
