...
3. **Will explore more in next week**:
   ...
   - [x] ~~How to fine-tune BERT using Keras3 + PyTorch + HF Transformers only?~~{: .secondary } _(NOT POSSIBLE)_
...
6. Planning to migrate all `/ref` pages to `/blog` because these aren't any different from them. Also, I don't write
   ...
   - :material-link-off: Migration may broke some links that I will fix later.
